...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control-plaintext" id="name" value="{{ $master->name }}" disabled readonly>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email:</label>
                <input type="text" class="form-control-plaintext" id="email" value="{{ $master->email }}" disabled readonly>
            </div>
        </div>
                ...
                <form action="{{ route('master_update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_name" name="name" value="{{ $master->name }}">
                        </div>

                        <div class="mb-3">
                            <label for="edit_email" class="form-label">Email:</label>
                            <input type="email" class="form-control" id="edit_email" name="email" value="{{ $master->email }}">
                        </div>
    ...
    @else
    <p>Data master tidak tersedia.</p>
    @endif
</div>
