                ...
                @foreach ($accountSections as $accountSection => $accountSubsections)
                    ...
                    @if (is_array($accountSubsections))
                        @foreach ($accountSubsections as $accountSubsection => $accountNames)
                            @foreach ($accountNames as $accountName)
                                <tr>
                                    @if ($firstSection)
                                        <td class="thead-light text-center align-middle"
                                            style="font-weight: bold; color: black; text-transform: uppercase;">
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        @if ($accountCode)
                                            <a href="{{ route('accoundeCode_edit', $accountCode) }}"
                    ...
                    @else
                        @foreach ($accountSubsections as $accountName)
                            <tr>
                                @if ($firstSection)
                                    <td style="font-weight: bold; color: black; text-transform: uppercase;">
                                        {{ $formattedAccountType }}</td>
                                    @php
                                        $firstSection = false;
                                    @endphp
