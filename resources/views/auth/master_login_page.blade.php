...
<head>
    ...
    <style>
        /* Copy the same styles from login_page.blade.php */
        body {
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="login-container w-full max-w-sm p-8 flex flex-col items-center">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Master Login</h2>
        <form method="POST" action="{{ route('master.login.post') }}" class="w-full">
            @csrf
            <div class="mb-4">
