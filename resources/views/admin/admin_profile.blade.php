...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @if (isset($admin))
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-user-shield me-2"></i>Profil Admin</h4>
                </div>
                <div class="card-body">
                    <!-- Summary Section -->
                    <div class="mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar"
                                        style="width: {{ $admin->name && $admin->email ? '100%' : '50%' }}"
                                        aria-valuenow="{{ $admin->name && $admin->email ? 100 : 50 }}" aria-valuemin="0"
                                        aria-valuemax="100">
                                        {{ $admin->name && $admin->email ? 'Lengkap (100%)' : 'Sebagian Lengkap (50%)' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control-plaintext" id="name" value="{{ $admin->name }}"
                            disabled readonly data-bs-toggle="tooltip" data-bs-placement="top" title="Nama admin">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email:</label>
                        <input type="text" class="form-control-plaintext" id="email" value="{{ $admin->email }}"
                            disabled readonly data-bs-toggle="tooltip" data-bs-placement="top" title="Email admin">
                    </div>
                </div>
        ...
        @else
            <p class="text-center text-muted">Data admin tidak tersedia.</p>
        @endif
    </div>
