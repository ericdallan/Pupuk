...
class CumulativeIncomeStatementExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    protected $data;
    protected $year;
    protected $month;
    ...
    {
        $period = $this->month
            ? 'Januari - ' . date('F', mktime(0, 0, 0, $this->month, 10)) . ' ' . $this->year
            : 'Tahun ' . $this->year;
